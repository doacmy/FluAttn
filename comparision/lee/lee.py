...
class Config:
    ...
    # train_csv = f"data/prd/time_series/{vtype}/Period/train.csv"
    # val_csv = f"data/prd/time_series/{vtype}/Period/val.csv"
    # test_csv = f"data/prd/time_series/{vtype}/Period/test_future.csv"
