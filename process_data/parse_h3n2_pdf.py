...
if filename in  ['2003-aug.pdf']:
    ...
    virus_df.to_csv(out_folder + filename.replace(".pdf", "") + ".csv", index=False)
elif filename in  ['2023-feb.pdf', '2023-sep.pdf', '2024-feb.pdf', '2024-sep.pdf', '2025-feb.pdf', '2025-sep.pdf']:
    pdf_path = os.path.join(pdf_folder, filename)
    ...
    with pdfplumber.open(pdf_path) as pdf:
        for page in pdf.pages:
            ...
            if filename == '2025-sep.pdf' and page_number == 57:
                continue
            ...
            if text and "Table" in text and "Neutralisation titre" not in text and "Neutralisation" not in text and ("Antigenic analysis of influenza AH3N2 viruses" in text or "Antigenic analysis of influenza A(H3N2) viruses" in text or  "Antigenic analyses of influenza A H3N2 viruses" in text or "Antigenic analysis of influenza A H3N2 viruses" in text or "Antigenic analyses of influenza A(H3N2) viruses" in text):
                ...
                text = text.replace('3131/2023/IDF-IPP29542/2023', '3131/2023 IDF-IPP29542/2023')
                text = text.replace('/3131/2023IDF-IPP29542/2023', '/3131/2023 IDF-IPP29542/2023')
                text = text.replace('/10685/2024H102423723/2024', '10685/2024 NSVH102423723/2024')
                text = text.replace('/08/2022olumbia/27/2023', '/08/2022 /27/2023')
                text = text.replace('/1187/202552/2024', '/1187/2025 52/2024')
                text = text.replace('A/Catalonia/A/Valladolidzerland', 'A/Catalonia A/Valladolid A/Switzerland')
                text = text.replace('information Columbia/27/202310136RV/2023 49/20242423723/2024 /47775/2024 /10685/2024 /1187/2025', 'information 27/2023 10136RV/2023 49/2024 2423723/2024 /47775/2024 /10685/2024 /1187/2025')
                text = text.replace('A/SloveniaA/Catalonia/A/Switzerland', 'A/Slovenia A/Catalonia A/Switzerland')
                text = text.replace('Columbia/27/20230136RV/2023', '27/2023 10136RV/2023')
                text = text.replace('49/20242423723/2024', '49/2024 2423723/2024')
                text = text.replace('A/Catalonia/A/Switzerland', 'A/Catalonia A/Switzerland')
                text = text.replace('A/Switzerland/NetherlandsA/Valladolid/NetherlandsA/ValladolidA/Catalonia', 'A/Switzerland A/Netherlands A/Valladolid A/Netherlands A/Valladolid A/Catalonia')
                text = text.replace('information 27/2023 10136RV/2023 49/2024 2423723/2024/47775/2024/10685/2024 /1187/2025/02093/2024 /1187/20252423723/2024', 'information 27/2023 10136RV/2023 49/2024 2423723/2024 /47775/2024 /10685/2024 /1187/2025 /02093/2024 /1187/2025 2423723/2024')
                text = text.replace('A/SwitzerlandA/NetherlandsA/ValladolidA/NetherlandsA/ValladolidA/Catalonia', 'A/Switzerland A/Netherlands A/Valladolid A/Netherlands A/Valladolid A/Catalonia')
                text = text.replace('/1187/20252423723/2024', '/1187/2025 2423723/2024')
                text = text.replace('Viruses Other A/DistrictOf A/Croatia/ A/Slovenia A/Catalonia A/SwitzerlandA/NetherlandsA/ValladolidA/Netherlands A/ValladolidA/Catalonia/', 'Viruses Other A/DistrictOf A/Croatia/ A/Slovenia A/Catalonia A/Switzerland A/Netherlands A/Valladolid A/Netherlands A/Valladolid A/Catalonia/')
                text = text.replace('Viruses Other A/DistrictOf A/Croatia/ A/Slovenia A/Catalonia A/SwitzerlandA/Netherlands A/ValladolidA/Netherlands A/ValladolidA/Catalonia/', 'Viruses Other A/DistrictOf A/Croatia/ A/Slovenia A/Catalonia A/Switzerland A/Netherlands A/Valladolid A/Netherlands A/Valladolid A/Catalonia/')
